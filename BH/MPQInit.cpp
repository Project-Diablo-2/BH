...
ItemAttributes ItemAttributeList[] = {
	...
	{"Perfect Topaz", "gpys", "Gem", 1, 1, 0, 0, 0, 0, 0, 0, 1040, 0},
	{"Flawless Sapphire", "glbs", "Gem", 1, 1, 0, 0, 0, 0, 0, 0, 520, 0},
	{"Perfect Sapphire", "gpbs", "Gem", 1, 1, 0, 0, 0, 0, 0, 0, 528, 0},
	{"Flawless Emerald", "glgs", "Gem", 1, 1, 0, 0, 0, 0, 0, 0, 136, 0},
	{"Perfect Emerald", "gpgs", "Gem", 1, 1, 0, 0, 0, 0, 0, 0, 144, 0},
	...
	{"El Rune", "r01s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Eld Rune", "r02s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Tir Rune", "r03s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Nef Rune", "r04s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Eth Rune", "r05s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Ith Rune", "r06s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Tal Rune", "r07s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Ral Rune", "r08s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Ort Rune", "r09s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Thul Rune", "r10s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Amn Rune", "r11s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Sol Rune", "r12s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Shael Rune", "r13s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Dol Rune", "r14s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Hel Rune", "r15s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Io Rune", "r16s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Lum Rune", "r17s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Ko Rune", "r18s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Fal Rune", "r19s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Lem Rune", "r20s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Pul Rune", "r21s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Um Rune", "r22s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Mal Rune", "r23s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Ist Rune", "r24s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Gul Rune", "r25s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Vex Rune", "r26s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Ohm Rune", "r27s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Lo Rune", "r28s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Sur Rune", "r29s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Ber Rune", "r30s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Jah Rune", "r31s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Cham Rune", "r32s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
	{"Zod Rune", "r33s", "Rune", 1, 1, 0, 0, 0, 0, 0, 0, 4096, 0},
...
void InitializeMPQData() {
	...
	if (MpqDataMap.find("itemtypes") != MpqDataMap.end()) {
	...
	if (MpqDataMap.find("armor") != MpqDataMap.end()) {
		for (auto d = MpqDataMap["armor"]->data.begin(); d < MpqDataMap["armor"]->data.end(); d++) {
			if ((*d)["code"].length() > 0) {
				...
				attrs->code[1] = (*d)["code"].c_str()[1] != ' ' ? (*d)["code"].c_str()[1] : 0;
				attrs->code[2] = (*d)["code"].c_str()[2] != ' ' ? (*d)["code"].c_str()[2] : 0;
				attrs->code[3] = (*d)["code"].c_str()[3] != ' ' ? (*d)["code"].c_str()[3] : 0;
				attrs->code[4] = 0;
	...
	if (MpqDataMap.find("weapons") != MpqDataMap.end()) {
	...
	if (MpqDataMap.find("misc") != MpqDataMap.end()) {
		for (auto d = MpqDataMap["misc"]->data.begin(); d < MpqDataMap["misc"]->data.end(); d++) {
			if ((*d)["code"].length() > 0) {
				...
				if (ancestorTypes.find("rune") != ancestorTypes.end() || ancestorTypes.find("runs") != ancestorTypes.end()) {
					flags2 |= ITEM_GROUP_RUNE;
				}
				if (ancestorTypes.find("gem0") != ancestorTypes.end() || ancestorTypes.find("gsm0") != ancestorTypes.end()) {
					flags2 |= ITEM_GROUP_CHIPPED;
				}
				else if (ancestorTypes.find("gem1") != ancestorTypes.end() || ancestorTypes.find("gsm1") != ancestorTypes.end()) {
				...
				else if (ancestorTypes.find("gemd") != ancestorTypes.end() || ancestorTypes.find("ggmd") != ancestorTypes.end()) {
					flags2 |= ITEM_GROUP_DIAMOND;
				}
				else if (ancestorTypes.find("geme") != ancestorTypes.end() || ancestorTypes.find("ggme") != ancestorTypes.end()) {
					flags2 |= ITEM_GROUP_EMERALD;
				}
				else if (ancestorTypes.find("gemr") != ancestorTypes.end() || ancestorTypes.find("ggmr") != ancestorTypes.end()) {
					flags2 |= ITEM_GROUP_RUBY;
				}
				else if (ancestorTypes.find("gems") != ancestorTypes.end() || ancestorTypes.find("ggms") != ancestorTypes.end()) {
					flags2 |= ITEM_GROUP_SAPPHIRE;
				}
				else if (ancestorTypes.find("gemt") != ancestorTypes.end() || ancestorTypes.find("ggmt") != ancestorTypes.end()) {
					flags2 |= ITEM_GROUP_TOPAZ;
				}
				else if (ancestorTypes.find("gemz") != ancestorTypes.end() || ancestorTypes.find("ggmz") != ancestorTypes.end()) {
