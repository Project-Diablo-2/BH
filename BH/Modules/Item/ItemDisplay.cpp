...
struct ReplacementSpec {
	...
	// COLOR keywords
	// %BLACK%
	static string ReplaceBlack(ReplaceContext& ctx, const ReplacementValue& val);
	// %CORAL%
	static string ReplaceCoral(ReplaceContext& ctx, const ReplacementValue& val);
	// %SAGE%
	static string ReplaceSage(ReplaceContext& ctx, const ReplacementValue& val);
	// %TEAL%
	static string ReplaceTeal(ReplaceContext& ctx, const ReplacementValue& val);
	// %LIGHT_GRAY%
	static string ReplaceLightGray(ReplaceContext& ctx, const ReplacementValue& val);
...
unordered_map<string, ReplacementSpec> ReplacementMap = {
	...
	// COLORS
	{ "BLACK", { 0, ReplacementSpec::ReplaceBlack } },
	{ "CORAL", { 0, ReplacementSpec::ReplaceCoral } },
	{ "SAGE", { 0, ReplacementSpec::ReplaceSage } },
	{ "TEAL", { 0, ReplacementSpec::ReplaceTeal } },
	{ "LIGHT_GRAY", { 0, ReplacementSpec::ReplaceLightGray } },
...
string ReplacementSpec::ReplaceBlack(ReplaceContext& ctx, const ReplacementValue& val)
{
	return *p_D2GFX_RenderMode != 4 ? "ÿc6" : "\xFF" "c\x02";
}

string ReplacementSpec::ReplaceCoral(ReplaceContext& ctx, const ReplacementValue& val)
{
	return *p_D2GFX_RenderMode != 4 ? "ÿc1" : "\xFF" "c\x06";
}

string ReplacementSpec::ReplaceSage(ReplaceContext& ctx, const ReplacementValue& val)
{
	return *p_D2GFX_RenderMode != 4 ? "ÿc2" : "\xFF" "c\x07";
}

string ReplacementSpec::ReplaceTeal(ReplaceContext& ctx, const ReplacementValue& val)
{
	return *p_D2GFX_RenderMode != 4 ? "ÿc3" : "\xFF" "c\x09";
}

string ReplacementSpec::ReplaceLightGray(ReplaceContext& ctx, const ReplacementValue& val)
{
